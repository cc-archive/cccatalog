...
def _process_object(obj):
    ...
    for img in image_list:
        ...
        total_images = image_store.add_item(foreign_landing_url=foreign_landing_url,
            image_url=image_url,
...
def _create_meta_data_dict(obj,
    max_description_length=MAX_DESCRIPTION_LENGTH):
    image_meta_data = {}
    description_text = obj.get('description')
    if description_text is not None:
        image_meta_data['description'] = " ".join(description_text.split(" ")[:MAX_DESCRIPTION_LENGTH])
    else:
